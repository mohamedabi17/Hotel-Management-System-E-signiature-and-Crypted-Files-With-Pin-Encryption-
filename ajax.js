...
function validId(val) {
    if (val == 1) {
        ...
        document.getElementById('id_card_no').setAttribute('data-error', "Entrez le numéro de carte d’identité nationale valide à 12 chiffres");
    } else if (val == 2) {
        ...
        document.getElementById('id_card_no').setAttribute('data-error', "Entrez 11 caractères(inclus '/') Numéro de carte d’électeur valide");
    } else if (val == 3) {
        document.getElementById('id_card_no').setAttribute('type', 'text');
        ...
        document.getElementById('id_card_no').setAttribute('data-error', "Entrez une carte de passeport valide de 10 caractères");
    } else if (val == 4) {
        document.getElementById('id_card_no').setAttribute('type', 'text');
        ...
        document.getElementById('id_card_no').setAttribute('data-error', "Entrez 16 caractères (espace inclus) numéro de licence valide");
    }
}
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.done == true) {
                ...
                $('.emp-response').html('<div class="alert bg-success alert-dismissable" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>Employeé Ajouté Avec Success</div>');
            } else {
...
$('#edit_employee').submit(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            alert("Employeé Ajouté Avec Success");
